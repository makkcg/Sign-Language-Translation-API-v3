 ...
 * Page class
 */
class accounts_edit extends accounts
{
	...
	// Page object name
	public $PageObjName = "accounts_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// words
			$this->words->setDbValueDef($rsnew, $this->words->CurrentValue, 0, $this->words->ReadOnly);

			// used_words
			$this->used_words->setDbValueDef($rsnew, $this->used_words->CurrentValue, 0, $this->used_words->ReadOnly);

			// remain_words
			$this->remain_words->setDbValueDef($rsnew, $this->remain_words->CurrentValue, 0, $this->remain_words->ReadOnly);
			...
			// expire_date
			$this->expire_date->setDbValueDef($rsnew, UnFormatDateTime($this->expire_date->CurrentValue, 0), NULL, $this->expire_date->ReadOnly);
