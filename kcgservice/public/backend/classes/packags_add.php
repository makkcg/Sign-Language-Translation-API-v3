 ...
 * Page class
 */
class packags_add extends packags
{
	...
	// Page object name
	public $PageObjName = "packags_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "packagsview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->number_of_words->CurrentValue = 0;
		$this->period_in_months->CurrentValue = 0;
	...
	protected function newRow()
	{
		...
		$row['number_of_words'] = $this->number_of_words->CurrentValue;
		$row['period_in_months'] = $this->period_in_months->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// number_of_words
		$this->number_of_words->setDbValueDef($rsnew, $this->number_of_words->CurrentValue, 0, strval($this->number_of_words->CurrentValue) == "");

		// period_in_months
		$this->period_in_months->setDbValueDef($rsnew, $this->period_in_months->CurrentValue, 0, strval($this->period_in_months->CurrentValue) == "");
