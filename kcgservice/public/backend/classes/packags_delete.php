 ...
 * Page class
 */
class packags_delete extends packags
{
	...
	// Page object name
	public $PageObjName = "packags_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("packagslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("packagslist.php"); // Return to list
			}
		}
	}
