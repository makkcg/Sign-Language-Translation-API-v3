 ...
 * Page class
 */
class news_delete extends news
{
	...
	// Page object name
	public $PageObjName = "news_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("newslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("newslist.php"); // Return to list
			}
		}
	}
