...
class users_list extends users
{
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->pwd->AdvancedSearch->toJson(), ","); // Field pwd
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->pwd, $arKeywords, $type);
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fuserslistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
