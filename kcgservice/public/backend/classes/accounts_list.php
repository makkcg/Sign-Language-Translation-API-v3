 ...
 * Page class
 */
class accounts_list extends accounts
{
	...
	// Page object name
	public $PageObjName = "accounts_list";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->words->AdvancedSearch->toJson(), ","); // Field words
		$filterList = Concat($filterList, $this->used_words->AdvancedSearch->toJson(), ","); // Field used_words
		$filterList = Concat($filterList, $this->remain_words->AdvancedSearch->toJson(), ","); // Field remain_words
		$filterList = Concat($filterList, $this->connection_points->AdvancedSearch->toJson(), ","); // Field connection_points
		$filterList = Concat($filterList, $this->package->AdvancedSearch->toJson(), ","); // Field package
		$filterList = Concat($filterList, $this->expire_date->AdvancedSearch->toJson(), ","); // Field expire_date
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function restoreFilterList()
	{
		...
		// Field words
		$this->words->AdvancedSearch->SearchValue = @$filter["x_words"];
		$this->words->AdvancedSearch->SearchOperator = @$filter["z_words"];
		$this->words->AdvancedSearch->SearchCondition = @$filter["v_words"];
		$this->words->AdvancedSearch->SearchValue2 = @$filter["y_words"];
		$this->words->AdvancedSearch->SearchOperator2 = @$filter["w_words"];
		$this->words->AdvancedSearch->save();

		// Field used_words
		$this->used_words->AdvancedSearch->SearchValue = @$filter["x_used_words"];
		$this->used_words->AdvancedSearch->SearchOperator = @$filter["z_used_words"];
		$this->used_words->AdvancedSearch->SearchCondition = @$filter["v_used_words"];
		$this->used_words->AdvancedSearch->SearchValue2 = @$filter["y_used_words"];
		$this->used_words->AdvancedSearch->SearchOperator2 = @$filter["w_used_words"];
		$this->used_words->AdvancedSearch->save();

		// Field remain_words
		$this->remain_words->AdvancedSearch->SearchValue = @$filter["x_remain_words"];
		$this->remain_words->AdvancedSearch->SearchOperator = @$filter["z_remain_words"];
		$this->remain_words->AdvancedSearch->SearchCondition = @$filter["v_remain_words"];
		$this->remain_words->AdvancedSearch->SearchValue2 = @$filter["y_remain_words"];
		$this->remain_words->AdvancedSearch->SearchOperator2 = @$filter["w_remain_words"];
		$this->remain_words->AdvancedSearch->save();

		// Field connection_points
		$this->connection_points->AdvancedSearch->SearchValue = @$filter["x_connection_points"];
		$this->connection_points->AdvancedSearch->SearchOperator = @$filter["z_connection_points"];
		$this->connection_points->AdvancedSearch->SearchCondition = @$filter["v_connection_points"];
		$this->connection_points->AdvancedSearch->SearchValue2 = @$filter["y_connection_points"];
		$this->connection_points->AdvancedSearch->SearchOperator2 = @$filter["w_connection_points"];
		$this->connection_points->AdvancedSearch->save();
		...
		// Field expire_date
		$this->expire_date->AdvancedSearch->SearchValue = @$filter["x_expire_date"];
		$this->expire_date->AdvancedSearch->SearchOperator = @$filter["z_expire_date"];
		$this->expire_date->AdvancedSearch->SearchCondition = @$filter["v_expire_date"];
		$this->expire_date->AdvancedSearch->SearchValue2 = @$filter["y_expire_date"];
		$this->expire_date->AdvancedSearch->SearchOperator2 = @$filter["w_expire_date"];
		$this->expire_date->AdvancedSearch->save();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->words); // words
			$this->updateSort($this->used_words); // used_words
			$this->updateSort($this->remain_words); // remain_words
			$this->updateSort($this->connection_points); // connection_points
			$this->updateSort($this->package); // package
			$this->updateSort($this->expire_date); // expire_date
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->phone->setSort("");
				$this->words->setSort("");
				$this->used_words->setSort("");
				$this->remain_words->setSort("");
				$this->connection_points->setSort("");
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"faccountslistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
