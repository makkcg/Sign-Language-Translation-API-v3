 ...
 * Page class
 */
class customers_delete extends customers
{
	...
	// Page object name
	public $PageObjName = "customers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("customerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("customerslist.php"); // Return to list
			}
		}
	}
