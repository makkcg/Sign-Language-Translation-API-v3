 ...
 * Page class
 */
class accounts_view extends accounts
{
	...
	// Page object name
	public $PageObjName = "accounts_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "accountslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "accountslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "accountslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
