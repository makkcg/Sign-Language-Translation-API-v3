...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.5");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "signwords"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'LpkhBJAOVfFh2Lq3', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/signwords.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{CCDF4E7E-11C4-4BCB-AC19-8C4385A0838C}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "kcgwebse_signservice", "pass" => "DSG8PfYw?0L8", "db" => "kcgwebse_signservice"]
	],
